          ...
          <div class="col-sm-12">
            <?php
              ...
              else
              {
                ...
                //Anibal Ramirez
                $sql ="SELECT * FROM tbl_users WHERE voted_for='ALR'";
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Anibal Ramirez</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                // Ana
                $sql ="SELECT * FROM tbl_users WHERE voted_for='ANA'";
                $result= mysqli_query($conn, $sql);
                ...
                // be
                $sql ="SELECT * FROM tbl_users WHERE voted_for='BE'";
                $result= mysqli_query($conn, $sql);
